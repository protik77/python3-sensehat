...
RUN curl -LO  https://archive.raspberrypi.org/debian/pool/main/r/rtimulib/librtimulib-dev_7.2.1-5_armhf.deb \
 ...
 && curl -LO https://archive.raspberrypi.org/debian/pool/main/r/rtimulib/python3-rtimulib_7.2.1-5_armhf.deb \
 && curl -LO https://archive.raspberrypi.org/debian/pool/main/p/python-sense-hat/python3-sense-hat_2.2.0-1_armhf.deb
 
 
RUN dpkg -i \
    librtimulib-dev_7.2.1-5_armhf.deb \
    librtimulib-utils_7.2.1-5_armhf.deb \
    librtimulib7_7.2.1-5_armhf.deb \
    python3-rtimulib_7.2.1-5_armhf.deb \
